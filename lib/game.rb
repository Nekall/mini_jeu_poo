...
#Méthode d'initialisation nom user + creation 4 ennemies
  def initialize(human_player)
    ...
    @@enemies << @player1 = Player.new("Jean-Michel Hacker")
    @@enemies << @player2 = Player.new("Martine VPN")
    @@enemies << @player3 = Player.new("Pierre-Henry HTML")
    @@enemies << @player4 = Player.new("David Bootstrap")
  end
